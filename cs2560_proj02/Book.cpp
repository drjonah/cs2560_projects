...
istream& operator >> (istream& is, Book& book) {
    ...
    getline(is, line);
    if (!isdigit(line[0])) {
        cerr << "Error: author count corrupted file. [content=" << line << "]" << endl;
    ...
    getline(is, line);
    if (!isdigit(line[0])) {
        cerr << "Error: year corrupted file. [content=" << line << "]" << endl;
        is.setstate(ios::failbit);
        return is;
    }
    ...
    getline(is, line); 
    if (!isdigit(line[0])) {
        cerr << "Error: cover corrupted file. [content=" << line << "]" << endl;
        is.setstate(ios::failbit);
        return is;
    }
    ...
    getline(is, line);
    if (!isdigit(line[0])) {
        cerr << "Error: price corrupted file. [content=" << line << "]" << endl;
        is.setstate(ios::failbit);
        return is;
    }
    ...
    getline(is, line);
    if (!isdigit(line[0])) {
        cerr << "Error: copies corrupted file. [content=" << line << "]" << endl;
        is.setstate(ios::failbit);
        return is;
    }
